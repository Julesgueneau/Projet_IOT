/*
  Projet IoT – V7 (JOIN BLOQUANT)
  Objectif : Ne jamais scanner le WiFi tant que LoRa n'est pas connecté.
*/
...
// --- TES IDENTIFIANTS (Déjà intégrés) ---
...
void setup() {
    ...
    // 1. Reset Module (Pour partir propre)
...
void loop() {
    ...
    if (nb > 0) {
        ...
        if (sendStatus.indexOf("Please join") != -1) {
            Serial.println("⚠️ PERTE DE CONNEXION DETECTÉE ! Reset nécessaire.");
